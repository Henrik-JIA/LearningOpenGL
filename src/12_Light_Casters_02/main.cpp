...
glm::vec3 lightAmbientStrength = glm::vec3(0.3f, 0.3f, 0.3f); // 环境光强度
...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    lightModel = glm::translate(lightModel, lightPos); // 移动到设置好的灯光位置
