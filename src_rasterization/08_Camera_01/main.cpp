...
glm::vec3 cameraToTarget = glm::vec3(0.0f, 0.0f, -1.0f); // 是相机朝向目标的方向向量
...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // 实际的目标点 = 相机位置 + 方向向量  = cameraPos + cameraToTarget → 得到的是相机正前方的一个点
    // view = glm::lookAt(cameraPos, cameraPos + cameraToTarget, cameraUp);
