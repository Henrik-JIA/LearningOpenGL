...
int main()
{
  ...
  // 加载模型（nanosuit）
  Model ourModel("../static/model/single_room_building/single_room_building.obj", false, true);
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for (unsigned int i = 0; i < NR_POINT_LIGHTS; i++)
    {
      ...
      // lightSourceShader.setVec3("pointLights[" + std::to_string(i) + "].ambient", 0.2f, 0.2f, 0.2f);
    ...
    // lightSourceShader.setVec3("directionLight.ambient", 0.2f, 0.2f, 0.2f);
